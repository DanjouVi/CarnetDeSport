      ...
      <div class="container">
          <%session.setAttribute("pageCourant","calendar");%>
            ...
            <div id="Calendar"> 
                ...
                <div class="row">
                    <div class="col-sm-2 col-sm-offset-1">
                        <button type="button" class="<%=classToday%> btn  btn-test btn-block btn-calendar btn-<%=estDansMois%>"  <% if(estDansMois){%> data-toggle="modal" data-target=".bs-example-modal-lg" <%}%>  ><%=jour%></button>
                    </div>
                    <%
                        for (j = 1; j < 7; j++) {
                    ...
                    %>
                    <div class="col-sm-2">
                        <button type="button"  value="<%=jour%>" class="<%=classToday%> btn  btn-test btn-block btn-calendar btn-<%=estDansMois%>" <% if(estDansMois){%> data-toggle="modal" data-target=".bs-example-modal-lg" onclick="dayClick(this.value,${mois.numMois},${mois.annee})"<%}%> ><%=jour%></button>
                    </div>
                    <%
                        }
                    %>
