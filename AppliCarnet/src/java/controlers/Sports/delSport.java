 ...
 * @author vivi
 */
@WebServlet(name = "delSport", urlPatterns = {"/delSport"})
public class delSport extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        HttpSession session = request.getSession();
         ...
         try{
             if(nbSeance==0){
                sportsDAO.delSport(nomSport,utilisateur); 
             }else{
                sportsDAO.delSeances(nomSport,utilisateur);
                sportsDAO.delSport(nomSport,utilisateur);
             }
